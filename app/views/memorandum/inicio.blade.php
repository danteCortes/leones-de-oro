...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      ...
      <a class="btn btn-primary" href="<?=URL::to('memorandum/nuevo-multiple/'.$empresa->ruc)?>">
        <i class="fa fa-plus-square"></i> Nuevo Memorandum Multiple
      </a>
    </div>
  </div>
  <div class="row">
                ...
                @foreach($memorandums as $memorandum)
                  @if($memorandum->usuario)
                    <tr>
                      ...
                      <td>
                        @if(count($memorandum->trabajadores) > 1)
                          <a class="btn btn-primary btn-xs" href="<?=URL::to('memorandum/editar-multiple/'.$memorandum->id)?>">
                            Editar
                          </a>
                        @else
